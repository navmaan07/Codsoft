...
if __name__ == '__main__':
    ...
    # Ask the user for the movie name input
    movie_name = input("Enter the movie name for recommendations: ").strip().lower()
    ...
    try:
        ...
        print(f"\nSorry, the movie '{movie_name}' was not found in the dataset. Please check the spelling and try again.")
